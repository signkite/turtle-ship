...
def result_from_angle(l_angle_init, r_angle_init):
    ...
    print("l_angle", l_angle, "r_angle", r_angle)

    l_value = abs(l_angle-l_angle_init) / l_angle_init * 100
    r_value = abs(r_angle-r_angle_init) / r_angle_init * 100

    mean = (l_value + r_value) / 2
